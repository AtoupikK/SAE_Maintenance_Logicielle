...
public class Graphique {
    ...
    /**
     * nvalid character '\\t' in string literal
     */
     ...
     * ```java
     * /**
     *  Cette méthode permet d'arrêter la musique de fond en cours de lecture.
     *
     *  @param None
     *  @return None
     * /
     ...
     * ```java
     * /**
     *  Méthode pour afficher le texte lié à une valeur donnée dans le tableau.
     *
     *  @param valeur L'index dans le tableau à partir duquel le texte est affiché.
     * /
